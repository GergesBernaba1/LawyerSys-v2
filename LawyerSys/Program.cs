...
builder.Services.AddScoped<IAiAssistantOrchestrationService, AiAssistantOrchestrationService>();
...
builder.Services.AddScoped<IContendersService, ContendersService>();
builder.Services.AddScoped<IDashboardService, DashboardService>();
builder.Services.AddScoped<IDemoRequestsService, DemoRequestsService>();
builder.Services.AddScoped<ILandingPageService, LandingPageService>();
builder.Services.AddScoped<INotificationsQueryService, NotificationsQueryService>();
builder.Services.AddScoped<ISubscriptionPackagesService, SubscriptionPackagesService>();
